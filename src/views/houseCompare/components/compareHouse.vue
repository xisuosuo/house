                    ...
                    <div node-type="module" class="module-lpcompare">
                        <table class="mtable" note-type="common-data" data-cityprefix="yt" data-domain="focus">
                            ...
                            <tr class="normal loupan-info" node-type="loupan-info">
                                ...
                                <td id="value-name-1">
                                    <div>
                                        <a>
                                            <img style="width: 120px;height: 90px;" v-bind:src="this.HouseData[0].image" alt="">
                                        </a>
                                    </div>
                                    <div id="name-1">{{this.HouseData[0].name}}</div>
                                </td>
                                <td id="value-name-2">
                                    <div>
                                        <a target="_blank"><img style="width: 120px;height: 90px;" v-bind:src="this.HouseData[1].image" alt=""></a>
                                    </div>
                                    <div id="name-2">{{this.HouseData[1].name}}</div>
                                </td>
                                <td id="value-name-3">
                                    <div>
                                        <a target="_blank"><img style="width: 120px;height: 90px;" v-bind:src="this.HouseData[2].image" alt=""></a>
                                    </div>
                                    <div id="name-3">{{this.HouseData[2].name}}</div>
                                </td>
                                <td id="value-name-4">
                                    <div>
                                        <a  target="_blank"><img style="width: 120px;height: 90px;" v-bind:src="this.HouseData[3].image" alt=""></a>
                                    </div>
                                    <div id="name-4">{{this.HouseData[3].name}}</div>
                                </td>
                            </tr>
                            <tr class="normal loupan-info" node-type="loupan-info">
                                <td class="key">价格</td>
                                <td id="value-price-1">
                                    <span id="price-1" class="price">{{this.HouseData[0].price}}</span>
                                </td>
                                <td id="value-price-2">
                                    <span id="price-2" class="price">{{this.HouseData[1].price}}</span>
                                </td>
                                <td id="value-price-3">
                                    <span id="price-3" class="price">{{this.HouseData[2].price}}</span>
                                </td>
                                <td id="value-price-4">
                                    <span id="price-4" class="price">{{this.HouseData[3].price}}</span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        <table class="mtable">
                            ...
                            <tr class="normal">
                                ...
                                <td id="value-years-1">{{this.HouseData[0].area}}</td>
                                <td id="value-years-2">{{this.HouseData[1].area}}</td>
                                <td id="value-years-3">{{this.HouseData[2].area}}</td>
                                <td id="value-years-4">{{this.HouseData[3].area}}</td>
                            </tr>
                            <tr class="normal">
                                <td class="key">销售信息</td>
                                <td id="value-devel-1">{{this.HouseData[0].isSelling}}</td>
                                <td id="value-devel-2">{{this.HouseData[1].isSelling}}</td>
                                <td id="value-devel-3">{{this.HouseData[2].isSelling}}</td>
                                <td id="value-devel-4">{{this.HouseData[3].isSelling}}</td>
                            </tr>
                            <tr class="normal">
                                <td class="key">建筑结构</td>
                                <td id="value-fitment-1">{{this.HouseData[0].houseFeature}}</td>
                                <td id="value-fitment-2">{{this.HouseData[1].houseFeature}}</td>
                                <td id="value-fitment-3">{{this.HouseData[2].houseFeature}}</td>
                                <td id="value-fitment-4">{{this.HouseData[3].houseFeature}}</td>
                            </tr>
                            <tr class="normal">
                                <td class="key">项目位置</td>
                                <td id="value-location-1">{{this.HouseData[0].address}}</td>
                                <td id="value-location-2">{{this.HouseData[1].address}}</td>
                                <td id="value-location-3">{{this.HouseData[2].address}}</td>
                                <td id="value-location-4">{{this.HouseData[3].address}}</td>
                            </tr>

                            <tr class="normal">
                                <td class="key">物业类别</td>
                                <td id="value-property-1">{{this.HouseData[0].houseType}}</td>
                                <td id="value-property-2">{{this.HouseData[1].houseType}}</td>
                                <td id="value-property-3">{{this.HouseData[2].houseType}}</td>
                                <td id="value-property-4">{{this.HouseData[3].houseType}}</td>
                            </tr>
                            </tbody>
                        </table>
                        <table class="mtable">
                            ...
                            <tr class="normal">
                                ...
                                <td id="value-housecount-1">{{this.HouseData[0].minFloorArea}}</td>
                                <td id="value-housecount-2">{{this.HouseData[1].minFloorArea}}</td>
                                <td id="value-housecount-3">{{this.HouseData[2].minFloorArea}}</td>
                                <td id="value-housecount-4">{{this.HouseData[3].minFloorArea}}</td>
                            </tr>
                            <tr class="normal">
                                <td class="key">最大面积㎡</td>
                                <td id="value-volume-1">{{this.HouseData[0].maxFloorArea}}</td>
                                <td id="value-volume-2">{{this.HouseData[1].maxFloorArea}}</td>
                                <td id="value-volume-3">{{this.HouseData[2].maxFloorArea}}</td>
                                <td id="value-volume-4">{{this.HouseData[3].maxFloorArea}}</td>
                            </tr>
                            <tr class="normal">
                                <td class="key">绿化率</td>
                                <td id="value-green-1">{{this.HouseData[0].greeningRate}}</td>
                                <td id="value-green-2">{{this.HouseData[1].greeningRate}}</td>
                                <td id="value-green-3">{{this.HouseData[2].greeningRate}}</td>
                                <td id="value-green-4">{{this.HouseData[3].greeningRate}}</td>
                            </tr>
                            <tr class="normal">
                                <td class="key">楼盘类型</td>
                                <td id="value-blockcount-1">{{this.HouseData[0].houseHeight}}</td>
                                <td id="value-blockcount-2">{{this.HouseData[1].houseHeight}}</td>
                                <td id="value-blockcount-3">{{this.HouseData[2].houseHeight}}</td>
                                <td id="value-blockcount-4">{{this.HouseData[3].houseHeight}}</td>
                            </tr>
                            <tr class="normal">
                                <td class="key">停车位（个）</td>
                                <td id="value-parking-1">
                                    <span class="park-row">{{this.HouseData[0].parkingSpace}}</span>
                                </td>
                                <td id="value-parking-2">
                                    <span class="park-row">{{this.HouseData[1].parkingSpace}}</span>
                                </td>
                                <td id="value-parking-3">
                                    <span class="park-row">{{this.HouseData[2].parkingSpace}}</span>
                                </td>
                                <td id="value-parking-4">
                                    <span class="park-row">{{this.HouseData[3].parkingSpace}}</span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
            ...
            getData() {
                ...
                Server.get({
                    ...
                    if (rsp.status === 1) {
                        switch (this_.count) {
                            case 0:
                                this_.HouseData[0] = rsp.data;
                                break;
                            case 1:
                                this_.HouseData[1] = rsp.data;
                                break;
                            case 2:
                                this_.HouseData[2] = rsp.data;
                                break;
                            case 3:
                                this_.HouseData[3] = rsp.data;
                                break;
                        }
                        // this.HouseData = rsp.data;
...
<style lang="less" scoped>
    ...
    .module-loupan-search .loupan-search-hover-show {
        width: 70px;
        height: 70px;
        float: left;
        margin-right: 8px;
    ...
    .module-loupan-search .loupan-search-right .loupan-search-title2 {
        font-size: 12px;
        color: #999;
        position: absolute;
        left: 78px;
    ...
    .module-lpcompare .mtable .compare {
        text-align: left;
        border: 0;
    ...
    .module-lpcompare .label {
        font-size: 16px;
        font-weight: 700;
        padding: 0 12px;
    }

    .module-lpcompare .query {
        height: 30px;
    ...
    .module-lpcompare .suggest-item .left-text {
    ...
    .module-lpcompare .suggest-item .name2 {
        font-size: 12px;
        color: #999;
        margin-left: 5px;
    }

    .module-lpcompare .suggest-item .red {
        font-weight: 700;
    }

    .module-lpcompare .suggest-item .suggest-dist {
        float: right;
        height: 30px;
        color: #999;
        max-width: 70px;
    ...
    .module-lpcompare .del {
        width: 11px;
        height: 11px;
        border: 1px #e43 solid;
        color: #e43;
        text-align: center;
        line-height: 11px;
        font-size: 11px;
    ...
    .module-lpcompare .features td {
        font-size: 0;
        text-align: left !important;
    }

    .module-lpcompare .feature {
        padding: 4px;
        background-color: #fff;
        color: #999;
    ...
    .module-lpcompare .mtable tr td:nth-child(2) {
        border-left: 0;
    }

    .module-lpcompare .mtable tr:nth-child(2) td {
        border-top: 0;
    }

    .module-lpcompare .mtable .key {
        width: 10%;
        background: #f8f8f8;
        border: 0;
    }

    .module-lpcompare .mtable .bus-row,
    .module-lpcompare .mtable .park-row {
        overflow: hidden;
        display: inline-block;
    }

    .module-lpcompare .mtable .value {
        width: 22.5%;
    }

    .module-lpcompare .mtable .headerd td {
        padding: 12px 0;
        background-color: #fff1ee;
        border: 0;
    }

    .module-lpcompare .mtable .title {
        text-align: left;
        /*width: 1200px;*/
        background-color: #fff1ee;
        color: #e43;
        border-left: 4px #e43 solid;
        padding-left: 22px;
        height: 35px;
        line-height: 35px;
        font-size: 16px;
    ...
    .module-lpcompare .lpcompare-tig {
        position: fixed;
        margin-left: -221px;
        margin-top: -55px;
        width: 440px;
    ...
    .module-lpcompare .lpcompare-tig .text {
        display: inline-block;
        padding-top: 37px;
        font-size: 20px;
        color: #333;
    ...
    .module-shopping-cart .right-triangle {
        ...
        width: 9px;
        height: 12px;
        background: url(//t1.focus-res.cn/front-pc/module/shopping-cart/images/right-triangle.png?1547637206583);
    ...
    .module-shopping-cart .root .headerd {
        border-bottom: 1px solid #e43;
        height: 45px;
    }

    .module-shopping-cart .root .headerd .sub {
        text-indent: 15px;
        line-height: 45px;
        font-size: 14px;
        color: #e43;
    ...
    .module-shopping-cart .root .headerd .sub-right {
        line-height: 45px;
        font-size: 14px;
        color: #999;
        float: right;
    ...
    .module-shopping-cart .root .headerd .sub-right .triangle {
        line-height: 45px;
        margin-left: 4px;
    ...
    .module-right-toolbar.show {
        animation: tbshow 0.8s;
        animation-fill-mode: forwards;
        right: 0 \9 \0;
    }

    .module-right-toolbar.hide {
        animation: tbhide 0.8s;
        right: -36px;
    }
    ...
    .module-common-float-dlg .cfdlg-ruzhu {
        ...
        background: #fff7ec;
        background: linear-gradient(to bottom, #fff7ec 0, #fff 60%);
    }
    ...
    .module-common-float-dlg .cfdlg-btnclose {
        ...
        height: 30px;
        cursor: pointer;
        background-image: url(//t1.focus-res.cn/front-pc/module/common-float-dlg/images/dlg-close.png?1547637206583);
    }

    .module-common-float-dlg .cfdlg-btnclose:hover {
        background-image: url(//t1.focus-res.cn/front-pc/module/common-float-dlg/images/dlg-close-hover.png?1547637206583);
    }
    ...
    .module-common-float-dlg .cfdlg-ruzhu .title {
        width: 233px;
        height: 64px;
        background-image: url(//t1.focus-res.cn/front-pc/module/common-float-dlg/images/ruzhu-title.png?1547637206583);
        margin: 33px auto 0;
    }
    ...
    .module-common-float-dlg .cfdlg-ruzhu .body {
        ...
        width: 405px;
        height: 108px;
        background-image: url(//t1.focus-res.cn/front-pc/module/common-float-dlg/images/ruzhu-body.png?1547637206583);
    ...
    .module-common-float-dlg .cfdlg-error,
    .module-common-float-dlg .cfdlg-feedback {
        width: 398px;
        border: 1px solid #d8d8d8;
    }

    .module-common-float-dlg .cfdlg-error .cfdlg-btnclose,
    .module-common-float-dlg .cfdlg-feedback .cfdlg-btnclose {
        top: 11px;
        right: 11px;
        cursor: pointer;
    }
    ...
    .module-common-float-dlg .cfdlg-panel .panel-result .panel-result-icon {
        ...
        width: 61px;
        height: 61px;
        background-image: url(//t1.focus-res.cn/front-pc/module/common-float-dlg/images/panel-result-icon-suc.png?1547637206583);
    }
