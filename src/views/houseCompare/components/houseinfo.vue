        ...
        <div style="margin-top: 55px">
            <Row :gutter="30">
                                ...
                                <div style="margin-top:40px;margin-left: 10px">
                                    <div>
                                        ...
                                        <Form :model="formItem" :label-width="70">
                                            <FormItem label="价格说明:">
                                                <span>价格说明：</span>在{{this.houseInfo.minPrice}}元/㎡ ~
                                                {{this.houseInfo.maxPrice}}元/㎡之间
                                            </FormItem>
                                            <FormItem label="建筑类型:">
              ...
              <span style="font-size: 14px">
                ...
                <strong>{{this.detailList[0].imagename}}</strong>
                                    ...
                                    <img style="height: 250px;width: 300px;margin: 10px" :src=detailList[0].image
                                         alt="">
                                </div>
                            </Col>
                            <Col span="12">
                    ...
                    <div style="border: 1px solid #dcdee2;">
                        <div style="padding: 14px;height: 280px;overflow-y: scroll">
                            ...
                            <Modal v-model="modal1" title="你的评价" @on-ok="ok">
                                <Input v-model="form.houseComments" type="textarea" :autosize="{minRows: 5,maxRows: 10}"
                                       placeholder="评价字数100-120字"/>
            ...
            <Card>
                <div class="around">
                    ...
                    <ul>
                        <li v-for="(value,index) in orderList" :key="index" @click="selectTimer(index,value)"
                            :class="timeIndex === index ? 'default-active' : 'default' ">{{ value.name }}
                        </li>
                    </ul>
                    <Row>
                        <Col span="17">
                            ...
                            <div class="list" id="mapListContainer">
                                ...
                                <div class="ul-box">
                                    <div class="around-no-info">
                                        <ul>
                                            <item v-for="(item,id) in listData" :key="item.id" :data="item" :id="id+1"
                                                  @on-item-click="onItemClick"/>
                                        </ul>
                                    </div>
                                </div>
                                <div class="page-footer" v-show="list.length>10">
                                    <Page :total="list.length" :page-size="pageSize" size="small"
              ...
              <strong>相似小区:</strong>
                            ...
                            <div class="map" style="height: 200px;width: 100%;">
                                <div v-for="(value,index) in BaseOnHouse" :key="index">
                                    <Col span="4">
                                        <img @click="onHouseclick(value,index)"
                                             style="width: 200px;height: 160px;margin: 5px" v-bind:src="value.image"
                                             alt="">
                                        <strong>
