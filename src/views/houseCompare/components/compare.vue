                ...
                <table class="mtable" note-type="common-data" data-cityprefix="yt" data-domain="focus">
                    ...
                    <tr>
                        <td class="compare" colspan="5">
                            ...
                            <span class="btn compare-btn" node-type="compare-btn" @click="showmapView">+对比</span>
                        </td>
                    </tr>
                    <tr class="normal loupan-info" node-type="loupan-info">
                        ...
                        <td id="value-name-2">
                            <div>
                                <a @click="getTwohouseinfo" target="_blank"><img style="width: 120px;height: 90px;"
                                                                                 v-bind:src="this.HouseTwo.image"
                                                                                 alt=""></a>
                            </div>
                        ...
                        <td id="value-name-3">
                            <div>
                                <a @click="getThreehouseinfo" target="_blank"><img style="width: 120px;height: 90px;"
                                                                                   v-bind:src="this.HouseThree.image"
                                                                                   alt=""></a>
                            </div>
                        ...
                        <td id="value-name-4">
                            <div>
                                <a @click="getFourhouseinfo" target="_blank"><img style="width: 120px;height: 90px;"
                                                                                  v-bind:src="this.HouseFour.image"
                                                                                  alt=""></a>
                            </div>
