        ...
        <Card style="margin: 0 auto;width: 1250px;margin-top: 70px;">
            <div node-type="module" class="module-lpcompare">
                <table class="mtable" note-type="common-data" data-cityprefix="yt" data-domain="focus"
                       data-photodomain="https://t.focus-img.cn">
                    <colgroup>
                        <col class="key">
                    ...
                    <tr class="normal loupan-info" node-type="loupan-info">
                        ...
                        <td id="value-name-1">
                            <div><a @click="gethouseinfo" target="_blank" title=" 海上明珠"><img
                                    id="avatar-1" class="avatar" src="../../../assets/img/44b8812c-cb76-4ac6-aa53-5f3ab4db1100.png" alt=""></a></div>
                            <div id="name-1"> 海上明珠</div>
                            <div class="ctrl-wrap"><span class="del" data-index="1" data-pid="110110771">╳</span></div>
                        </td>
                        <td id="value-name-2">
                            <div><a @click="gethouseinfo" target="_blank" title="南山协信天骄城"><img
                                    id="avatar-2" class="avatar" src="../../../assets/img/83056b78-9f82-4b8b-ae23-2c3538e49fe0.png" alt=""></a></div>
                            <div id="name-2">南山协信天骄城</div>
                            <div class="ctrl-wrap"><span class="del" data-index="2" data-pid="110099217">╳</span></div>
                        </td>
                        <td id="value-name-3">
                        </td>
                        <td id="value-name-4">
                    ...
                    <tr class="normal loupan-info" node-type="loupan-info">
                        <td class="key">价格</td>
                        <td id="value-price-1">平均价格：<span id="price-1" class="price">18000元/㎡</span></td>
                        <td id="value-price-2">平均价格：<span id="price-2" class="price">6500元/㎡</span></td>
                ...
                <table class="mtable">
                    ...
                    <tr class="normal">
                        ...
                        <td id="value-location-1">芝罘 北马路与西南河交汇处<a href=""
                                                                  class="maplink" target="_blank">查看地图</a></td>
                        <td id="value-location-2">龙口 齐鲁医院南山分院北侧<a href=""
                                                                  class="maplink" target="_blank">查看地图</a></td>
                ...
                <table class="mtable">
                    ...
                    <tr class="normal">
                        ...
                        <td id="value-bus-1"><span class="bus-row"
                                                   title="烟台市口腔医院站点，停靠：3路 3路刘家 6路 11路 17路 18路 18路竹林寺 28路 32路 37路 46路 47路 50路 50路杨家台子 高铁巴士1号线">烟台市口腔医院站点，停靠：3路 3路刘家 6路 11路 17路 18路 18路竹林寺 28路 32路 37路 46路 47路 50路 50路杨家台子 高铁巴士1号线<span></span></span>
                        </td>
                        <td id="value-bus-2"><span class="bus-row" title="乘9、101、5、10、13到协信天骄城下车即可">乘9、101、5、10、13到协信天骄城下车即可<span></span></span>
                        </td>
                ...
                <table class="mtable">
                    ...
                    <tr class="normal">
                        <td class="key">停车位</td>
                        <td id="value-parking-1"><span class="park-row" title="323个">323个</span></td>
                        <td id="value-parking-2"><span class="park-row" title="805个（地上80个，地下725个）">805个（地上80个，地下725个）</span>
                        </td>
                ...
                <div class="lpcompare-tig" node-type="lpcompare-tig" style="display: none;">
                    <p class="text">点评成功</p>
                </div>
            </div>
        </Card>
...
<style lang="less" scoped>
    ...
    .module-lpcompare .mtable .bus-row, .module-lpcompare .mtable .park-row {
        overflow: hidden;
        display: inline-block
    }
