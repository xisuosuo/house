   <template>
    <Sider ref="side1" :width='180'> -->
        <Menu active-name="" theme="dark" width="auto" :open-names="['']">
            ...
            <Submenu name="2">
                <template slot="title">
                    <Icon type="md-speedometer" /> 数据展示 </template>
                <router-link to="/data">
                    <MenuItem name="2-1">
            ...
            <Submenu name="4">
                <template slot="title">
                    <Icon type="md-globe" /> 区位资源 </template>
            ...
            <Submenu name="7">
                <template slot="title">
                    <Icon type="ios-radio" /> 房价分析 </template>
            ...
            <Submenu name="8">
                <template slot="title">
                    <Icon type="md-analytics" /> 房价预测 </template>
                <router-link to="/GWR">
                    <MenuItem name="8-2">
            ...
            <Submenu name="10">
                <template slot="title">
                    <Icon type="md-paper" /> 用户手册 </template>
