<template>
    <Layout>
        <Content>
            <div style="margin: 0 auto;margin-top: 65px;width:1100px;">
                <Row>
                    <Col span="20">
                        <Card>
                            <div slot="title">
                            ...
                            <Form :model="formItem" :label-width="80">
                                ...
                                <Row>
                                    <Col span="10">
                                        <FormItem label="教育">
                                            <Slider v-model="formItem.school" :step="10" show-stops
                                                    @on-input="add()"></Slider>
                                        </FormItem>
                                    </Col>
                                    <Col span="1">
                                ...
                                <Row>
                                    <Col span="10">
                                        <FormItem label="医疗">
                                            <Slider v-model="formItem.hosptial" :step="10" show-stops
                                                    @on-input="add"></Slider>
                                        </FormItem>
                                    </Col>
                                    <Col span="1">
                                ...
                                <Row>
                                    <Col span="10">
                                        <FormItem label="交通">
                                            <Slider v-model="formItem.station" :step="10" show-stops
                                                    @on-input="add"></Slider>
                                        </FormItem>
                                    </Col>
                                    <Col span="1">
                                ...
                                <Row>
                                    <Col span="10">
                                        <FormItem label="休闲娱乐">
                                            <Slider v-model="formItem.market" :step="10" show-stops
                                                    @on-input="add"></Slider>
                                        </FormItem>
                                    </Col>
                                    <Col span="1">
                    ...
                    <Col span="4">
                        <div>
                            <img class="light" v-show="!downIcon" @click="change"
                                 src="../../../assets/img/lightbulb1.png">
                            <img class="light" v-show="downIcon" @click="change"
                                 src="../../../assets/img/lightbulb2.png">
