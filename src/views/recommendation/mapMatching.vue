          ...
          <ul class="clear">
            ...
            <li class="li-filter fl" @click="showOrder">
              ...
              <ul id="drop-list" style="display: none;">
                <li v-for="(value,index) in orderList" :key="index" @click="giveOrder(value)">{{ value.name }}</li>
              </ul>
            </li>
          </ul>
        </div>
      ...
      <Drawer title="安邦花园" :closable="false" v-model="info" width="23%">
        <div style="overflow: hidden;">
          ...
          <div style="float:right;height: 100px;width: 160px;margin-top:8px">
            <ul>
              <li>
                <span style="font-weight:bold; font-size:14px">小区高度类型:</span>{{houseHeight}}</li>
              <li>
                <span style="font-weight:bold; font-size:14px">小区类型:</span>{{houseType}}</li>
              <li>
                <span style="font-weight:bold; font-size:14px">绿化率:</span>{{greeningRate}}</li>
              <li>
                <span style="font-weight:bold; font-size:14px">停车位:</span>{{parkingSpace}}</li>
            </ul>
          </div>
        </div>
        ...
        <div v-for="(value,index) in detailList" style="margin-top:20px;border-bottom:1px solid #999;">
          ...
          <div style="width:130px;height:40px;float:right;margin-right:25px;">
            <p style="font-weight:bold; font-size:14px;text-align:center;margin-top:5px">{{value.imagename}}</p>
