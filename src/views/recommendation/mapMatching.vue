                        ...
                        <ul class="clear">
                            ...
                            <li class="li-filter fl" @click="showOrder">
                                ...
                                <ul id="drop-list" style="display: none;">
                                    <li v-for="(value,index) in orderList" :key="index" @click="giveOrder(value)">{{
                                        value.name }}
                                    </li>
                                </ul>
                            </li>
                    ...
                    <div class="list-wrap1">
                        <div class="hd" id="part" style="display: none">
                            ...
                            <Badge :count=this.count style="float: right;margin-right: 10px">
                                <Icon title="楼盘对比" @click="addComapre" type="ios-notifications-outline"
                                      size="26"></Icon>
                            </Badge>
                            <img title="我的收藏夹" @click="jumpCollect" src="../../assets/img/sumcollect.png" alt=""
                                 style="float: right;height: 20px;width: 20px;margin-top: 7px;margin-right: 10px">
                        </div>
                    </div>
                    <div class="list-wrap">
                    </div>
