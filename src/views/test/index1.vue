<template>
  <div>
    <div id="viewDiv" region="center">
      ...
      <div class="tool" style="margin-top:60px;">
        ...
        <!-- <ul>
          ...
          <li id="switchbasemap" @click="onToggleLayer">
            ...
            .then(
              ([
                ...
                var closestFacilityTask = new ClosestFacilityTask(
                  "http://122.112.216.247:6080/arcgis/rest/services/CHUZHOU/closeAnalysis/NAServer/CloseFacility"
                );
                this.params = new ClosestFacilityParameters();
                this.params.impedenceAttribute = "Miles";
                ...
                //服务点
                this.params.facilities = new FeatureSet();
                //事件点
                this.params.incidents = new FeatureSet();
                console.log(this.params);
                //点障碍
                this.params.pointBarriers = new FeatureSet();
                this.params.outSpatialReference = map.SpatialReference;
