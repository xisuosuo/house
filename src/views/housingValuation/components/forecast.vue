<template>
    <div class="themes" style="text-align: center;overflow-y: hidden">
                ...
                <div id="part1" class="map" style=";margin: 0 auto;height: 650px;width: 1200px;border:1px;">
                    <div title="数据台账">
                        <div class="group-panel-box blue">
                            ...
                            <Input  search enter-button="确 定"  @on-search="next" style="margin:auto;margin-top:250px;width:600px;border:2.5px solid #2b85e4" placeholder="请输入小区名称或地址" />
        ...
        <div id="part2"
             style=" display: none; height: 650px;background-color: #f9f9fb;text-align: center;">
                            ...
                            <div style="margin: 20px">
                                <div style="background-color:#f8f8f9;height:120px;width: 100%;">
                                    ...
                                    <div style="text-align: left">
                                        <span style="font-size: 14px;margin-right: 300px;margin-left: 20px;"><a href="#">房贷计算器</a></span>
                            ...
                            <Tabs value="name1">
                                <TabPane label="小区评级" name="name1">
                                    <div style="overflow: hidden;text-align: left">
                                        <div class="image"
                                             style="margin: 0 10px; height: 150px;width: 200px;float: left">
    ...
    export default {
        ...
        methods: {
            ...
            aroundMap() {
                ...
                var cities = ['长乐小区', '长乐小区', '长乐小区', '长乐小区', '长乐小区', '长乐小区', '长乐小区', '长乐小区'];
                var barHeight = 50;
